...
def greet_user(update, context):
	...
	txt_prompt1 = "Чтобы играть было удобнее, увеличь время до перехода телефона в спящий режим или вовсе отключи авто-переход в спящий режим на время игры."
	txt_prompt2 = "Отключи блокировку книжной ориентации и режим энергосбережения на телефоне."
	txt_choice = "Если хочешь продолжить игру нажми кнопку КАТЕГОРИИ. Чтобы остановить бота нажми СТОП-ИГРА."
...
def categories(update, context):
	...
	txt_choice1 = "Выбери одну из категорий, которые будут предложены чуть позже. Все игроки в комнате выбирают одинаковую категорию."
	txt_prompt3 = "Когда выбор будет сделан, ты получишь случайную карточку. Содержимое будет видно через 5 секунд после загрузки."
	txt_prompt4 = "Щелкни по карточке, активируя фулл-скрин показ. Далее переверни телефон в горизонтальное положение экраном от себя."
	txt_choice2 = "Выбери вариант и наслаждайся игрой."
	#вывод сообщений-подсказок на экран
